...
motor_info motor_info_t[MOTOR_MAX_NUM];		//¸³Óè×î´óµÄ7¸ö×Ö½Ú
motor_info motor_info_can_2[MOTOR_MAX_NUM];		//¸³Óè×î´óµÄ7¸ö×Ö½Ú
...
uint8_t rx_data[8]; //é¥æŽ§å™¨æŽ¥å—å€¼

uint8_t Rx[128]; //å¯¼èˆªæŽ¥å—å€¼
/* USER CODE END 0 */
...
//	HAL_NVIC_SetPriority(SysTick_IRQn,1,1);//µ÷¸ßHAL_DelayµÄÊ±ÖÓÖÐ¶ÏÓÅÏÈ¼¶
  ...
  USART6_Init();
	...
	__HAL_UART_ENABLE_IT(&huart1,UART_IT_IDLE); //å¯¼èˆªæ•°æ®æŽ¥æ”¶
