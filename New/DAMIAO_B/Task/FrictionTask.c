...
static void Friction_init()
{
	...
	pid_init(&motor_m2006_pid[5],20,0.03,0.5);//拨盘(拨爪)
...
static void Friction_calc()
{
	...
	motor_m3508[2].set_v=15*350;
	motor_m3508[3].set_v=-15*350;
	motor_m3508[4].set_v=15*350;
...
{motor_m2006[5].send_I = pid_cal_s(&motor_m2006_pid[5], motor_m2006[5].speed, motor_m2006[5].set_v,16384,16384);
	motor_m2006[6].send_I = pid_cal_s(&motor_m2006_pid[6], motor_m2006[6].speed, motor_m2006[6].set_v,16384,16384);
